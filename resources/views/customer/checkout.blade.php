        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                    ...
                    @if (!empty($promoCode))
                        <div class="flex items-center justify-between p-3 my-4 rounded-lg bg-green-50 border border-green-200">
                            <div>
                                <p class="text-sm text-green-700 font-medium">Kode Promo Diterapkan:</p>
                                <p class="font-semibold text-green-800">{{ $promoName ?? $promoCode }}</p>
                                @if(!empty($discountPercent))
                                    <p class="text-sm text-green-700">Diskon {{ $discountPercent }}%</p>
                                @endif
                            </div>
