                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        @if (($totalDiscount ?? 0) > 0)
                            <div
                                class="flex justify-between items-center py-3 border-b border-gray-100 bg-green-50 -mx-4 px-4">
                                <div>
                                    <p class="font-semibold text-green-800">BANKBCA</p>
                                    <p class="text-sm text-green-600">{{ $promoName ?? 'Diskon' }}
                                        ({{ $discountPercent ?? 0 }}%)</p>
                                </div>
                                <p class="font-semibold text-green-800">-Rp
                                    {{ number_format($totalDiscount ?? 0, 0, ',', '.') }}</p>
                            </div>
                        @endif
                    </div>
