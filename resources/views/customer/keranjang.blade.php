...
@section('content')
    ...
    <section class="min-h-screen">
        {{-- Container untuk breadcrumb dan konten utama --}}
        <div class="p-4 md:p-8">
            {{-- Header dengan breadcrumb dan judul --}}
            <div class="mb-6">
                {{-- Breadcrumb --}}
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-sm">
                        ...
                        <li class="flex items-center">
                            ...
                            <span
                                class="ml-2 text-transparent bg-clip-text bg-gradient-to-br from-green-500 via-green-400 to-blue-400 font-medium truncate max-w-xs">Keranjang</span>
                        </li>
                    </ol>
                </nav>
                        ...
                        @if (count($cart) > 0)
                            ...
                            <div class="space-y-3 mb-6 max-h-80 overflow-y-auto pr-2">
                                @foreach ($cart as $id => $item)
                                    <div
                                        class="bg-gradient-to-r from-blue-50 to-white border border-blue-100 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                            ...
                            <div class="text-center py-8">
                                <div class="bg-blue-50 rounded-xl p-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                        ...
                                        class="mx-auto text-blue-400 mb-3">
                                        <circle cx="9" cy="21" r="1"></circle>
                                        <circle cx="20" cy="21" r="1"></circle>
                                ...
                                @foreach ($tiket->groupBy('category') as $category => $items)
                                    <div class="mb-8">
                                        <div class="flex items-center gap-3 mb-4">
                                            ...
                                            <h3 class="font-semibold text-lg text-blue-800 capitalize">
                                                {{ $category }}
                                            </h3>
                                        </div>
                                            ...
                                            @foreach ($items as $ticket)
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($inCart)
                                                            <div
                                                                class="flex items-center gap-3 bg-white border border-blue-200 rounded-xl px-4 py-2">
                                                                <form
                                                                    action="{{ route('keranjang.update', $ticket->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                ...
                                                                <span
                                                                    class="w-8 text-center font-semibold text-gray-900 text-lg">{{ $quantity }}</span>
                                                                <form
                                                                    action="{{ route('keranjang.update', $ticket->id) }}"
                                                                    method="POST">
                                                                    @csrf
                        ...
                        @else
                            <div class="text-center py-12">
                                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                                    ...
                                    <path
                                        d="m9.5 7.5-2 2a4.95 4.95 0 1 0 7 7l2-2m-7-7 2-2a4.95 4.95 0 1 1 7 7l-2 2m-7-7 7 7" />
                                </svg>
