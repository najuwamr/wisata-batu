...
@section('content')
    <section class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-8">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden group">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute top-6 right-6">
                                <div
                                    class="bg-white/95 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-2xl transform hover:scale-105 transition-transform duration-300">
                            ...
                            <div class="absolute top-6 left-6">
                                <span
                                    class="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                                    Tiket Masuk
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @foreach (['Kolam Renang', 'Akuarium', 'Taman Lumut', 'Water Park', 'Taman Bunga'] as $fasilitas)
                                    <div
                                        class="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-green-50 rounded-xl border border-blue-100">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl shadow-2xl p-8 text-white">
                        ...
                        <a href="{{ route('keranjang') }}"
                            ...
                            <button class="cursor-pointer">Pesan Tiket</button>
                        </a>
                    ...
                    <div class="bg-white rounded-3xl shadow-2xl p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                <div
                                    class="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
            ...
            <!-- Related Tickets -->
            @if (isset($otherTickets) && $otherTickets->count() > 0)
                <div class="mt-16">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($otherTickets as $otherTicket)
                            <div
                                class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                                <!-- Image Section -->
                                <div class="h-48 bg-gradient-to-br from-blue-400 to-purple-500 relative overflow-hidden">
                                    @if ($otherTicket->image)
                                        <img src="{{ asset('images/' . $otherTicket->image) }}"
                                            alt="{{ $otherTicket->name }}" class="w-full h-full object-cover">
                                    ...
                                    <div class="absolute top-4 right-4">
                                        <span class="bg-white/90 text-gray-800 px-3 py-1 rounded-full text-sm font-bold">
                                            Rp {{ number_format($otherTicket->price, 0, ',', '.') }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ route('guest.tiket.detail', $otherTicket->id) }}"
            ...
            @else
                <!-- Empty State jika tidak ada tiket lainnya -->
                <div class="text-center py-12 bg-gray-50 rounded-2xl">
                    ...
                    <h3 class="text-xl font-bold text-gray-700 mb-2">Tidak Ada Tiket Lainnya</h3>
                    <p class="text-gray-500 mb-6">Silakan lihat semua tiket yang tersedia</p>
                    <a href="{{ route('guest.tiket') }}"
