    ...
    <div class="flex items-center justify-between px-6 py-3">
        ...
        <div class="flex items-center space-x-8">
            ...
            <ul class="hidden lg:flex items-center space-x-6 font-poppins font-medium text-blue-700">
                <li><a href="/" class="text-[#ff0f0f] hover:text-blue-700">Tiket & Promo</a></li>
...
<nav id="navbar" class="fixed z-[9999] bg-white shadow-xl w-full transform -translate-y-full transition-transform duration-300 ease-in-out">
    <div class="flex items-center justify-between px-6 py-3">
        <div class="flex items-center space-x-8">
            <div class="flex-shrink-0">
                <img src="{{ asset('assets/customer/selecta-logo1.png') }}" alt="Selecta Logo" class="h-12">
...
<script>
    ...
    window.addEventListener('scroll', function () {
        ...
        if (window.scrollY > 50) { // Angka 50 bisa diubah sesuai keinginan
