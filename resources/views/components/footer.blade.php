    ...
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center md:text-left">
                ...
                <div class="space-y-4">
                    <!-- WhatsApp -->
                    <a href="https://wa.me/62341591025" target="_blank"
                        class="flex items-center gap-3 p-3 bg-blue-800 rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-blue-200 text-sm">+62 341 591 025</p>
                        </div>
                    </a>

                    <!-- Instagram -->
                    <a href="https://instagram.com/tamanrekreasiselecta" target="_blank"
                        class="flex items-center gap-3 p-3 bg-blue-800 rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        <div
                            class="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 16 16">
                                <path
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-blue-200 text-sm">@tamanrekreasiselecta</p>
                        </div>
                    </a>
                    <a href="https://instagram.com/tamanrekreasiselecta" target="_blank"
                        class="flex items-center gap-3 p-3 bg-blue-800 rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        <div
                            class="w-10 h-10 bg-white rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="text-left">
                            <p class="font-semibold text-white">Tiktok</p>
                            <p class="text-blue-200 text-sm">@tamanrekreasiselecta</p>
                        </div>
                    </a>
                </div>
            ...
            {{-- Maps --}}
            <div class="text-center md:text-left">
                <h3 class="font-bold text-xl mb-6 text-white">Peta Lokasi</h3>
        ...
        {{-- Copyright --}}
        <div class="border-t border-blue-700 mt-12 pt-6">
