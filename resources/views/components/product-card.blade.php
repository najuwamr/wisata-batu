            ...
            <div class="mb-4 text-left">
                ...
                @if(!empty($product->image))
                    <img id="previewGambar-{{ $product->id }}"
                        ...
                        alt="Preview Gambar"
                        class="w-full h-40 object-contain rounded border mb-2 bg-transparent">
                @else
                    <div id="previewGambar-{{ $product->id }}"
                        class="w-full h-40 flex items-center justify-center border rounded mb-2 text-gray-500 font-semibold bg-transparent">
                        Gambar
                    </div>
                @endif
